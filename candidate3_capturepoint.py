...
class Candidate3Env(AnkleHipEnv):
    ...
    def step(self, action):
        ...
        # safety: CAPTURE POINT. capture_point = com_y + com_y_dot/omega0
        ...
        excess = np.clip(abs(capture_point) - self.base_half_width, 0.0, None) / self.base_half_width
        ...
        info = {"com_y": com_y, "com_x": com_x, "target_y": self.target_y, "h": h,
                ...
                "safety": safety, "capture_point": capture_point}
...
if __name__ == "__main__":
    ...
    model.save("ppo_candidate3_capturepoint")
    env.save("vecnormalize_candidate3_capturepoint.pkl")
    env.close()