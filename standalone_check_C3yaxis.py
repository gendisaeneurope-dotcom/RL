...
model = PPO.load("ppo_candidate3_yaxis_050_1")
for ep in range(5):
    venv = DummyVecEnv([lambda: TimeLimit(Candidate3Env(), max_episode_steps=1000)])
    venv = VecNormalize.load("vecnormalize_candidate3_yaxis_050_1.pkl", venv)
