"""
Candidate 1: target-reaching, no safety term.
Standalone version
"""
import os
...
# confirmed that URDF zero pose matches this sim's zero pose
...
if __name__ == "__main__":
    ...
    model.save("ppo_candidate1_A")
    env.save("vecnormalize_candidate1_A.pkl")
    env.close()
