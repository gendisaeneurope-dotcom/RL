"""
Candidate 1_C: target-reaching, no safety term. (tracking ÷ target_range stays, effort → action-based)
...
if __name__ == "__main__":
    ...
    model.save("ppo_candidate1_C")
    env.save("vecnormalize_candidate1_C.pkl")
    env.close()
