...
df.to_csv(os.path.join(output_dir, "custom_reward_trajectories.csv"), index=False)
...
summary.to_csv(os.path.join(output_dir, "custom_reward_episode_summary.csv"), index=False)
...
fig1.write_image(os.path.join(output_dir, "episode_rewards.png"))

with open(os.path.join(output_dir, "episode_rewards.png.meta.json"), "w") as f:
    json.dump({
...
fig2.write_image(os.path.join(output_dir, "pole_angle_trajectories.png"))

with open(os.path.join(output_dir, "pole_angle_trajectories.png.meta.json"), "w") as f:
    json.dump({
...
fig0.write_image(os.path.join(output_dir, "training_reward.png"))

with open(os.path.join(output_dir, "training_reward.png.meta.json"), "w") as f:
    json.dump({
...
fig0b.write_image(os.path.join(output_dir, "training_episode_length.png"))

with open(os.path.join(output_dir, "training_episode_length.png.meta.json"), "w") as f:
    json.dump({
...
fig0c.write_image(os.path.join(output_dir, "training_reward_per_step.png"))

with open(os.path.join(output_dir, "training_reward_per_step.png.meta.json"), "w") as f:
    json.dump({
