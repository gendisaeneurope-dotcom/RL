"""
Candidate 1_D: target-reaching, no safety term. apply both changes from B and C together.
...
if __name__ == "__main__":
    ...
    model.save("ppo_candidate1_D")
    env.save("vecnormalize_candidate1_D.pkl")
    env.close()
