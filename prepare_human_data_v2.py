...
After this, every human trial and every sim episode can be compared
directly without any direction-matching logic at all.
...
INPUT_PATH = "C:\\Gepi10\\SPACEMED\\Sem4_Thesis\\Thesis\\Workspace\\Gymnasium_RL\\RL\\human_com_cleaned_subject003.csv"
OUTPUT_PATH = "C:\\Gepi10\\SPACEMED\\Sem4_Thesis\\Thesis\\Workspace\\Gymnasium_RL\\RL\\human_com_cleaned_subject003_v2.csv"
...
# so ALL trials end up pointing the same (leftward/decreasing) way.
...
print("Use HUMAN_COMX_COL = 'com_x_aligned' and this new file path in the RMSE script.")
