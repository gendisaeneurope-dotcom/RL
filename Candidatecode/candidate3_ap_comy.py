...
How it structurally different from Candidate 2's safety term:
...
class Candidate3Env(AnkleHipEnv):
    """Candidate F's baseline (energy + tracking) plus capture-point safety + com_y stabilization."""
    ...
    def __init__(self, target_x_low=TARGET_X_LOW, target_x_high=TARGET_X_HIGH, fixed_target=None, omega=OMEGA,
                 ...
                 com_y_weight=COM_Y_WEIGHT, disturb_prob=0.1, force_range=(0, 30), **kwargs):
    ...
    def step(self, action):
        ...
        # com_y stabilization -- THE MISSING LINE. com_y_weight was declared
        # in __init__ but never applied to the reward before tonight's fix.
...
if __name__ == "__main__":
    ...
    model.save("ppo_candidate3_ap_comy1")
    env.save("vecnormalize_candidate3_ap_comy1.pkl")
    env.close()
