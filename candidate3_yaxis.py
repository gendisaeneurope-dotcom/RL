...
Stay penalty removed; safety weight matched to C2's swept value.
...
class Candidate3Env(AnkleHipEnv):
    """Tracking on com_y (ML); capture-point safety on com_x (AP)."""
    ...
    def step(self, action):
        ...
        # CAPTURE POINT on the AP axis. Identical extrapolation to XCoM,
        # but penalises only the excess beyond the base of support --
        # zero-valued while safely inside.
...
if __name__ == "__main__":
    log_dir = "./training_logs_candidate3_yaxis_050_1/"
    ...
    model.save("ppo_candidate3_yaxis_050_1")
    env.save("vecnormalize_candidate3_yaxis_050_1.pkl")
    env.close()
